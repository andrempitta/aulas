...
# writer() -> Gera um objeto para que possamos escrever em um arquivo CSV. Utilzamos o
# método writerow() para escrever cada linha. Este método recebe uma lista.
...
with open('udemy_131_filmes3.csv', 'w') as arquivo:
